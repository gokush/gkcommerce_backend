...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="/css/seller_manager.css">
  ...
  <body class="skin-blue">
    <div class="wrapper">
      ...
      <header class="main-header">
        <!-- Logo -->
        <a href="index2.html" class="logo">Goku Commerce</a>
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href=""><i class="fa fa-angle-double-right"></i> 用户</a></li>
                <li><a href=""><i class="fa fa-angle-double-right"></i> 用户组</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
              ...
              <ul class="treeview-menu">
                <li><a href=""><i class="fa fa-angle-double-right"></i> 账号</a></li>
                <li><a href=""><i class="fa fa-angle-double-right"></i> 配置</a></li>
              </ul>
            </li>

            <li><a href="documentation/index.html"><i class="fa fa-book"></i> 帮助文档</a></li>
